...
pub struct Serial_ {
    pub _base: Stream,
    pub peek_buffer: ::core::ffi::c_int,
    pub _rx_buffer_head: u8,
    pub _rx_buffer_tail: u8,
    pub _rx_buffer: [::core::ffi::c_uchar; 64usize],
}
pub const Serial__ONE_STOP_BIT: Serial___bindgen_ty_1 = 0;
pub const Serial__ONE_AND_HALF_STOP_BIT: Serial___bindgen_ty_1 = 1;
pub const Serial__TWO_STOP_BITS: Serial___bindgen_ty_1 = 2;
pub type Serial___bindgen_ty_1 = ::core::ffi::c_uint;
pub const Serial__NO_PARITY: Serial___bindgen_ty_2 = 0;
pub const Serial__ODD_PARITY: Serial___bindgen_ty_2 = 1;
pub const Serial__EVEN_PARITY: Serial___bindgen_ty_2 = 2;
pub const Serial__MARK_PARITY: Serial___bindgen_ty_2 = 3;
pub const Serial__SPACE_PARITY: Serial___bindgen_ty_2 = 4;
pub type Serial___bindgen_ty_2 = ::core::ffi::c_uint;
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_5beginEm"]
    pub fn Serial__begin(this: *mut Serial_, arg1: ::core::ffi::c_ulong);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_5beginEmh"]
    pub fn Serial__begin1(this: *mut Serial_, arg1: ::core::ffi::c_ulong, arg2: u8);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_3endEv"]
    pub fn Serial__end(this: *mut Serial_);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_9readBreakEv"]
    pub fn Serial__readBreak(this: *mut Serial_) -> i32;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_4baudEv"]
    pub fn Serial__baud(this: *mut Serial_) -> u32;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_8stopbitsEv"]
    pub fn Serial__stopbits(this: *mut Serial_) -> u8;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_10paritytypeEv"]
    pub fn Serial__paritytype(this: *mut Serial_) -> u8;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_7numbitsEv"]
    pub fn Serial__numbits(this: *mut Serial_) -> u8;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_3dtrEv"]
    pub fn Serial__dtr(this: *mut Serial_) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_3rtsEv"]
    pub fn Serial__rts(this: *mut Serial_) -> bool;
}
impl Serial_ {
    #[inline]
    pub unsafe fn begin(&mut self, arg1: ::core::ffi::c_ulong) {
        Serial__begin(self, arg1)
    }
    #[inline]
    pub unsafe fn begin1(&mut self, arg1: ::core::ffi::c_ulong, arg2: u8) {
        Serial__begin1(self, arg1, arg2)
    }
    #[inline]
    ...
    #[inline]
    pub unsafe fn readBreak(&mut self) -> i32 {
        Serial__readBreak(self)
    }
    #[inline]
    ...
    pub unsafe fn stopbits(&mut self) -> u8 {
        Serial__stopbits(self)
    }
    #[inline]
    pub unsafe fn paritytype(&mut self) -> u8 {
        Serial__paritytype(self)
    }
    #[inline]
    pub unsafe fn numbits(&mut self) -> u8 {
        Serial__numbits(self)
    }
    #[inline]
    pub unsafe fn dtr(&mut self) -> bool {
        Serial__dtr(self)
    }
    #[inline]
    pub unsafe fn rts(&mut self) -> bool {
        Serial__rts(self)
    }
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_9availableEv"]
    pub fn Serial__available(this: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_4peekEv"]
    pub fn Serial__peek(this: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_4readEv"]
    pub fn Serial__read(this: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_17availableForWriteEv"]
    pub fn Serial__availableForWrite(
        this: *mut ::core::ffi::c_void,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Serial_5flushEv"]
    pub fn Serial__flush(this: *mut ::core::ffi::c_void);
}
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct TwoWire {
